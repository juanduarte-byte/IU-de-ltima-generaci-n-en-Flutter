...
/// An effect that applies an animated fragment shader to the target widget.
///
/// The [shader] is the fragment shader to apply.
/// The [update] callback is called every frame to update the shader's uniforms.
/// The [layer] determines how the shader is blended with the target widget.
@immutable
